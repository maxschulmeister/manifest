...
/** Retained for tests/docs; not advertised to the model when the manifest bridge is active. */
...
export function buildCursorToolManifestText(
  ...
  const lines = [
    ...
    '- Agent tools execute in the calling agent runtime; Manifest only forwards tool_calls.',
